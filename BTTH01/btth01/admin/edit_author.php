            ...
            <div class="col-sm">
                ...
                <form action="process_edit_author.php" method="post">
                    <div class="input-group mt-3 mb-3">
                        ...
                        <input type="text" class="form-control" name="txtAuthorId" value="<?php echo $ma_tgia; ?>">
                    </div>

                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblAuthorName">Tên tác giả</span>
                        <input type="text" class="form-control" name="txtAuthorName" value="<?php echo $ten_tgia; ?>">
                    </div>
