                    ...
                    <tbody>
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<td><a href='edit_article.php?id={$row['ma_tgia']}'><i class='fa-solid fa-pen-to-square'></i></a></td>";
                                echo "<td><a href='delete_article.php?id={$row['ma_tgia']}'><i class='fa-solid fa-trash'></i></a></td>";
                                echo "</tr>";
                                $index++;
                            }
                        } else {
